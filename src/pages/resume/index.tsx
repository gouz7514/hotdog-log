        ...
        <div>
          ...
          <div style={{ marginBottom: '12px' }}>
            <div className="big-paragraph">
              소비자의 진심을 읽고 나도 사용하고 싶은 서비스의 개발을 지향합니다.
              빠르게 변화하는 소비자의 니즈를 서비스에 반영할 수 있도록 뉴스레터와 ProductHunt등을 보며 트렌드를 파악하고 항상 고민합니다.
              <br />
              <br />
              12만 회원, 1,000만 MAU 를 가진 국내 1위 바이오링크 서비스, 인포크링크를 개발한 경험이 있습니다.
              프론트엔드 도메인에 국한되지 않고 AWS, Docker, Nginx 등 다양한 도메인에 대해 항상 고민하고 학습합니다.
              <br />
              <br />
              웹 기반 데이터를 기반으로 한 소통, 의사결정을 통해 목표를 달성하는 팀을 만들어 나가고 싶습니다.
              체계적인 개발 문화, 뚜렷한 목표를 갖고 열심히 고민하는 문화를 갈망합니다.
              그동안의 경험을 토대로 팀과 함께 부피뿐 아니라 밀도 있는 개발을 하고 싶습니다.
            </div>
          </div>
